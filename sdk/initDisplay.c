...
void initDisplay() {
    ...
    if(displayConf->resolution < displayConfigResolution.RES_640x480) {
        set_sys_clock_pll(1440000000, 6, 2); //VCO frequency (MHz), PD1, PD2 -- see vcocalc.py
    }
    else if(displayConf->resolution < displayConfigResolution.RES_1024x768) {
        //configure for 640x480 resolution
    }
    else if(displayConf->resolution == displayConfigResolution.RES_1024x768) {
        //configure for 1024x768
    }
